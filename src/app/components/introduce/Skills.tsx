    ...
    >
      ...
      <div className="w-full flex flex-wrap pb-10">
        <div className="w-full flex flex-wrap gap-2 pb-2">
          <h3 className="text-pink-500 text-xl font-semibold w-full pt-4">
            Core
          </h3>
          ...
          <Card className="p-2 sm:p-4 w-full max-w-sm">
            ...
            <CardContent>
              <p className="text-xs sm:text-sm pl-2">
                객체지향 언어인 Java 및 JVM에 대한 이해를 바탕으로 Java 문법을
                구사할 수 있습니다
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="p-2 sm:p-4 w-full max-w-sm">
            ...
            <CardContent>
              <p className="text-xs sm:text-sm pl-2">
                간단한 C++을 활용하여 MFC 로 UI및 응용프로그램을 만들 수 있고
                MFC 기반 Web Server 를 유지보수한 경험이 있습니다
              </p>
            </CardContent>
          </Card>
          <h3 className="text-pink-500 text-xl font-semibold w-full pt-4">
          ...
          <Card className="p-2 sm:p-4 w-full max-w-sm">
            ...
            <CardContent>
              <p className="text-xs sm:text-sm pl-2">
                함수형 컴포넌트 활용 및 디자인 패턴에 맞게 컴포넌트를 설계 및
                활용할 수 있고 컴포넌트 생명주기, React Hook을 상황에 맞게
                활용할 수 있습니다. 최신 React 기술에도 꾸준히 관심을 가지고
                프로젝트에 접목하고 있습니다
              </p>
            </CardContent>
          </Card>
          <Card className="p-2 sm:p-4 w-full max-w-sm">
            ...
            <CardContent>
              <p className="text-xs sm:text-sm pl-2">
                App Router 및 Page Router 활용이 가능하며 SSR, SSG, ISR 방식으로
                화면을 렌더링 할 수 있습니다. React 의 lazy에 해당하는 dynamic
                import 를 활용한 코드스플리팅 활용도 가능합니다. MetaData 를
                활용한 SEO 향상, next/font 를 활용한 폰트 적용 등 Nextjs 활용에
                능숙합니다
              </p>
            </CardContent>
          </Card>
          <Card className="p-2 sm:p-4 w-full max-w-sm">
            ...
            <CardContent>
              <p className="text-xs sm:text-sm pl-2">
                Remix 를 활용하여 프로젝트를 구성하고 활용할 수 있습니다. Remix
                에서 React Router v7로 마이그레이션하고 프로젝트를 구성할 수
                있습니다
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="p-2 sm:p-4 w-full max-w-sm">
            ...
            <CardContent>
              <p className="text-xs sm:text-sm pl-2">
                tanstack-query(react-query)를 활용한 API 호출 및 서버상태 관리를
                수행할 수 있습니다. 커스텀 훅 작성 및 캐싱 전략,
          ...
          <Card className="p-2 sm:p-4 w-full max-w-sm">
            ...
            <CardContent>
              <p className="text-xs sm:text-sm pl-2">
                ...
                운영할 수 있습니다. MVC 패턴에 익숙하며 JPA, Mybatis 를 활용한
                DB 트랜잭션을 수행할 수 있습니다
              </p>
            </CardContent>
          </Card>
        ...
        <div className="w-full flex flex-wrap gap-2 pb-2">
          ...
          <Card className="p-2 sm:p-4 w-full max-w-sm">
            ...
            <CardContent>
              <p className="text-xs sm:text-sm pl-2">
                Storybook 을 통한 단위 컴포넌트 테스트 및 통합 테스트를 작성하고
                수행할 수 있습니다. 페이지를 배포하여 디자이너 및 QA 와 내용을
                공유할 수 있습니다
              </p>
            </CardContent>
          </Card>
          <Card className="p-2 sm:p-4 w-full max-w-sm">
            ...
            <CardContent>
              <p className="text-xs sm:text-sm pl-2">
                Jest 를 활용하여 단위 테스트를 수행할 수 있습니다. 주로 작성한
                함수가 올바르게 작동하는지 테스트합니다.
              </p>
            </CardContent>
          </Card>
        </div>
